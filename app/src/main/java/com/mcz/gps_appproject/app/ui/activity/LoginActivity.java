package com.mcz.gps_appproject.app.ui.activity;
...
import com.mcz.gps_appproject.MainActivity;
import com.mcz.gps_appproject.R;
import com.mcz.gps_appproject.app.ui.base.LoginBaseActivity;
import com.mcz.gps_appproject.app.utils.Config;
import com.mcz.gps_appproject.app.utils.DataManager;
import com.mcz.gps_appproject.app.utils.WaitDialogUtil;
...
//        String uspwd = sp.getString("userpwd", "YtFEJCiVM0UfQju75B51ZN0tIe8a");
        //华为
        String usname = sp.getString("appId", "T7oYyF740CWa7ADjNt9Dhf4ZWVQa");
        String uspwd = sp.getString("userpwd", "PiiECmbmh5C2OU9KxNMFCWVAd9Ea");
//        String usaddress = sp.getString("seraddress", "180.101.147.89");
        String usaddress = sp.getString("seraddress", "49.4.92.191");
