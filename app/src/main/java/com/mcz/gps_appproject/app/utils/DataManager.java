package com.mcz.gps_appproject.app.utils;
...
import static com.mcz.gps_appproject.app.utils.Config.SELFCERTPATH;
import static com.mcz.gps_appproject.app.utils.Config.SELFCERTPWD;
import static com.mcz.gps_appproject.app.utils.Config.TRUSTCAPATH;
import static com.mcz.gps_appproject.app.utils.Config.TRUSTCAPWD;
...
//命令下发
    public static String Comened_DEVICEID(Context mContext, String serverurl,String app_key,String accessToken,String deviceId,String Switch)
            throws Exception{
        List<NameValuePair> params = new ArrayList<NameValuePair>();

        params.add(new BasicNameValuePair("deviceId", deviceId));
        params.add(new BasicNameValuePair("serviceId", "GPS"));
        params.add(new BasicNameValuePair("method", "Beep"));
...
//删除直连设备
    ...
    public static String UPDATE_DEVICEID(Context mContext, String serverurl,String app_key,String accessToken,String name)
        ...
        params.add(new BasicNameValuePair("model", "GPS"));
